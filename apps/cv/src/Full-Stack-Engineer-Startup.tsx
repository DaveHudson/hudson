...
function FullStackEngineerStartup() {
  return (
    <div className="flex flex-col prose min-w-full pt-8">
      <div className="flex flex-col mx-auto text-left max-w-4xl">
        ...
        <p className="prose-em mb-0">AITech • Nov 2023 - Present</p>
        <RoleSummary text="Open-source AI Engineer" />
        <Ratios ratios={AIEngineerRatios} />
        <p className="mb-0">
          Open AI • Anthropic • FAL AI • Hugging Face • LangChain • Vercel AI SDK • Cohere • React • Ollama • Serverless
          Lambda • React • Tailwind
        </p>
        <a href="https://github.com/DaveHudson/basechat" target="_blank" className="pt-2 pb-2">
          Github Repo
        </a>
...
export default FullStackEngineerStartup;
